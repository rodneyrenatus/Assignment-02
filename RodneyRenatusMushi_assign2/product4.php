  ...
  <main class="content-clearfix">
    ...
    <section id="products" class="product-showcase">
      ...
      <div class="product-grid">
        ...
        <article class="product-card">
          <figure>
            <img src="images/succ_mix.jpg" alt="Succulent Soil Mix">
            <figcaption>Premium Soil Blend</figcaption>
          </figure>
          <div class="card-body">
            <h3>Succulent Soil Mix (2kg)</h3>
            <p>Our own blend of 50% organic matter and 50% inorganic grit (perlite +
               coarse sand). Fast-draining and pH-balanced to keep cacti and succulents
               healthy. Enough for 6–8 small pots.</p>
            <dl class="plant-specs">
              <dt>Weight</dt><dd>2 kg bag</dd>
              <dt>Covers</dt><dd>6–8 small pots</dd>
            </dl>
        ...
        <article class="product-card">
          <figure>
            <img src="images/fertilizer.jfif" alt="Cactus Fertiliser">
            <figcaption>Slow-Release Granules</figcaption>
          </figure>
          <div class="card-body">
            <h3>Cactus Fertiliser</h3>
            <p>Slow-release granular fertiliser formulated with a low nitrogen ratio
               suitable for cacti and succulents. Sprinkle on soil surface — lasts
               up to 3 months per application. 100g pouch.</p>
            <dl class="plant-specs">
              <dt>Format</dt><dd>Slow-release granules</dd>
              <dt>Duration</dt><dd>Up to 3 months</dd>
            </dl>
            <div class="card-footer">
        ...
        <article class="product-card">
          <figure>
            <img src="images/gift_bundle.webp" alt="Gift Bundle">
            <figcaption>Ready to Gift</figcaption>
          </figure>
          <div class="card-body">
            <h3>Gift Bundle Set</h3>
            <p>A curated bundle containing one hand-picked succulent, a matching
               terracotta pot, a small bag of soil mix, and a printed care guide card.
               Wrapped in kraft paper with jute twine — ready to give.</p>
            <dl class="plant-specs">
              <dt>Includes</dt><dd>Plant, pot, soil, care card</dd>
              <dt>Wrapping</dt><dd>Kraft paper + jute</dd>
            </dl>
            <div class="card-footer">
        ...
        <article class="product-card">
          <figure>
            <img src="images/a1.avif" alt="Watering Can">
            <figcaption>Gentle Watering</figcaption>
          </figure>
          <div class="card-body">
            <h3>Watering Can (Small)</h3>
            <p>A compact, lightweight plastic watering can perfect for everyday plant
               care. Its gentle rose-head spout distributes water evenly without
               disturbing soil or splashing leaves. Essential for seedling trays and
               small collections. Capacity: 500 ml.</p>
            <dl class="plant-specs">
              <dt>Capacity</dt><dd>500 ml</dd>
              <dt>Spout</dt><dd>Rose-head spray</dd>
            </dl>
            <div class="card-footer">
        ...
        <article class="product-card">
          <figure>
            <img src="images/a2.webp" alt="Garden Tool Set">
            <figcaption>3-Piece Tool Set</figcaption>
          </figure>
          <div class="card-body">
            <h3>Garden Tool Set</h3>
            <p>A compact 3-piece stainless steel tool set including a narrow trowel,
               a transplanting fork, and a soil cultivator. Sized for small pots and
               indoor use. Ergonomic handles reduce hand fatigue during repotting
               sessions. Rust-resistant and easy to clean.</p>
            <dl class="plant-specs">
              <dt>Pieces</dt><dd>3 (trowel, fork, cultivator)</dd>
              <dt>Material</dt><dd>Stainless steel</dd>
            </dl>
            <div class="card-footer">
        ...
        <article class="product-card">
          <figure>
            <img src="images/a3.webp" alt="Spray Bottle">
            <figcaption>Fine Mist Sprayer</figcaption>
          </figure>
          <div class="card-body">
            <h3>Spray Bottle</h3>
            <p>A fine-mist pump spray bottle ideal for lightly moistening propagation
               trays, misting cuttings, and cleaning dust from smooth-leaved succulents.
               The adjustable nozzle switches between a fine mist and a direct stream.
               Capacity: 300 ml. Refillable with plain or lightly diluted water.</p>
            <dl class="plant-specs">
              <dt>Capacity</dt><dd>300 ml</dd>
              <dt>Nozzle</dt><dd>Adjustable mist / stream</dd>
            </dl>
            <div class="card-footer">
        ...
        <article class="product-card">
          <figure>
            <img src="images/a6.jpg" alt="Plant Labels">
            <figcaption>Identification Labels</figcaption>
          </figure>
          <div class="card-body">
            <h3>Plant Labels (Pack)</h3>
            <p>A pack of 20 reusable white plastic plant labels with a waterproof
               surface that accepts both pencil and permanent marker. UV-resistant
               for outdoor use. Essential for any serious collector to track species
               names, purchase dates, and care notes.</p>
            <dl class="plant-specs">
              <dt>Quantity</dt><dd>20 labels per pack</dd>
              <dt>Surface</dt><dd>Waterproof, UV-resistant</dd>
            </dl>
            <div class="card-footer">
        ...
        <article class="product-card">
          <figure>
            <img src="images/a7.webp" alt="LED Grow Light">
            <figcaption>Full-Spectrum Grow Light</figcaption>
          </figure>
          <div class="card-body">
            <h3>LED Grow Light</h3>
            <p>A full-spectrum LED grow light panel that supplements or replaces
               natural sunlight for indoor plants. Produces a balanced spectrum covering
               blue (vegetative growth) and red (flowering) wavelengths. Energy-efficient,
               low heat, and adjustable in height via a clamp mount. Ideal for bringing
               dim-corner plants into thriving condition.</p>
            <dl class="plant-specs">
              <dt>Spectrum</dt><dd>Full spectrum (blue + red)</dd>
              <dt>Mount</dt><dd>Adjustable clamp</dd>
            </dl>
            <div class="card-footer">
        ...
        <article class="product-card">
          <figure>
            <img src="images/a8.webp" alt="Pebble Decoration">
            <figcaption>Decorative Top Dressing</figcaption>
          </figure>
          <div class="card-body">
            <h3>Pebble Decoration</h3>
            <p>A bag of smooth, mixed-size decorative pebbles for top-dressing your
               plant pots. A 1–2 cm layer over the soil surface reduces moisture
               evaporation, prevents soil splash, deters fungus gnats, and gives
               your arrangement a clean, professional finish. Available in natural
               grey and warm tan tones. 500g bag.</p>
            <dl class="plant-specs">
              <dt>Weight</dt><dd>500g bag</dd>
              <dt>Colour</dt><dd>Mixed natural tones</dd>
            </dl>
            <div class="card-footer">
              <span class="price">RM 21.00</span>
              <a href="order.php" class="buy-btn">Order Now</a>
            </div>
          </div>
        </article>
        ...
        <article class="product-card">
          <figure>
            <img src="images/a9.webp" alt="Plant Stand">
            <figcaption>Display Stand</figcaption>
          </figure>
          <div class="card-body">
            <h3>Plant Stand</h3>
            <p>A simple, elegant metal plant stand that elevates your pot off the
               floor or tabletop, improving air circulation around the drainage hole
               and preventing moisture damage to surfaces. The open ring design fits
               pots from 10–18 cm diameter. Available in matte black and gold finishes.
               Height: 15 cm.</p>
            <dl class="plant-specs">
              <dt>Fits Pots</dt><dd>10–18 cm diameter</dd>
              <dt>Finish</dt><dd>Matte black / gold</dd>
            </dl>
            <div class="card-footer">
    ...
    <section id="pricing">
      ...
      <div class="content-box">
        <table>
          <thead>
            <tr><th>Product</th><th>Price (RM)</th><th>Details</th></tr>
          </thead>
          <tbody>
            <tr><td>Succulent Soil Mix (2kg)</td><td>RM 15.00</td><td>Covers 6–8 pots</td></tr>
            <tr><td>Cactus Fertiliser</td><td>RM 12.00</td><td>100g, 3-month supply</td></tr>
            <tr><td>Gift Bundle Set</td><td>RM 35.00</td><td>Plant + pot + soil + card</td></tr>
            <tr><td>Watering Can (Small)</td><td>RM 6.00</td><td>500ml, rose-head</td></tr>
            <tr><td>Garden Tool Set</td><td>RM 20.00</td><td>3-piece stainless</td></tr>
            <tr><td>Spray Bottle</td><td>RM 4.00</td><td>300ml, adjustable nozzle</td></tr>
            <tr><td>Plant Labels (Pack)</td><td>RM 7.00</td><td>20 labels, waterproof</td></tr>
            <tr><td>LED Grow Light</td><td>RM 56.00</td><td>Full spectrum, clamp mount</td></tr>
            <tr><td>Pebble Decoration</td><td>RM 21.00</td><td>500g mixed natural tones</td></tr>
            <tr><td>Plant Stand</td><td>RM 25.00</td><td>10–18cm pots, metal</td></tr>
          </tbody>
        </table>
      </div>
    </section>
